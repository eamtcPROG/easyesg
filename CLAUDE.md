...
diffed like the contract, each event's authority a readable path in it, and since task 148 the api's own copy of it held equal), `pnpm facade:check`, `pnpm routes:check`,
