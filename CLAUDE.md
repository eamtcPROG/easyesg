...
`pnpm --filter @easyesg/api config:seed` — nine artefacts since task 33.1, three of them the taxonomy
registry's and regenerated by `tools/extract-vsme-taxonomy.mjs` rather than hand-edited. `.github/workflows/gates.yml` runs four jobs on every
