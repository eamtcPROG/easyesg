...
|---|---|---|
| OQ-1 | **What is the final text of Moldova's sustainability-reporting law?** | Consultation on the Ministry of Finance's draft amendment to the Law on Accounting and Financial Reporting ran to 19 August 2026. Sources describe it inconsistently as open and as closed. The final text defines the platform's initial domestic compliance target population. Also logged in `architecture.md` OQ-8 |
...
| OQ-5 | **Is the official EFRAG Digital Template available in Romanian?** | The template ships in 11 languages; Romanian was not confirmed among them. Affects how much label content must be platform-authored, and its official standing |
