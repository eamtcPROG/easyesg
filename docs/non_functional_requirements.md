...
Fifteen items, of which **five are now closed** (OQ-2, OQ-3, OQ-5, OQ-13, and the mail half of OQ-9) as of 18 Aug 2026. OQ-4, OQ-6, OQ-7, OQ-8, OQ-10 and OQ-15 remain open because a source states an obligation without a threshold, and no number has been supplied for any of them here.
