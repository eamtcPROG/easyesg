...
The two `vsme-*` files are **extracted, not authored**:
...
| --- | --- | --- |
| `2026-05-01` | [`VSME-XBRL-Taxonomy-May-2026.zip`](https://xbrl.efrag.org/downloads/vsme/VSME-XBRL-Taxonomy-May-2026.zip) | recorded on regeneration |
