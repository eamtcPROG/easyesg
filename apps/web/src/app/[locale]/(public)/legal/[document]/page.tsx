 ...
 *
 * Terms of service · privacy notice · cookie policy, plus the cookie choice. One shared layout
 * treating the three as a set, with a plain-language summary above the formal text.
 *
