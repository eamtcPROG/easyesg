...
/**
 * S-13's record, in its create mode — its **loading — initial** (§8.1, UX-90; task 137), on S-16's precedent: the whole body waits
 ...
 * `force-dynamic`.
 */
export default async function NewEntityLoading() {
