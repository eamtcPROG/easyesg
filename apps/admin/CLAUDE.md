...
and are not kept once their view unmounts — their key root is separate so invalidating the log cannot reach them. **A-18, identity providers, since task 67.11**, in
