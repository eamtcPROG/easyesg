 ...
 *
 * The socket-ticket route, the Redis ticket store, the admission that re-reads the session, and the socket itself on
 * the api's own HTTP server (§12.5.6's task-147 rows). Task 148 adds the fan-out of the worker's hints.
 *
