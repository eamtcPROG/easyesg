 ...
 * forbid.
 *
 * **One method, and it answers with counts as well as rows.** Splitting "the page" from "how many
 * matched" would be two statements that can disagree — a row removed between them makes a pager
 * offer a page that is no longer there.
 */
