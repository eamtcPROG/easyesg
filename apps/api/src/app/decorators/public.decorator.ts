 ...
 *    own handler verifies, and task 28.2's `AdminRealmGuard` is what will make that a chain rather
 *    than a controller's own checking. Marking it here is what stops the tenant guard 401-ing the
